...
// 0.85 (was 0.95) — kid testers reported quiz narration ran too fast and
// merged question + choices. 0.85 reads ~12% slower; combined with the
// real wall-clock gap between question and choices in speakQuizQuestion
// (1200ms) the question now feels like a clearly-paused sentence
// instead of a single rushed block.
...
// SHA-256 of "v5|" + voice + "|" + text → stable cache key. The "v5"
// prefix bump invalidates all v4 cached audio when TTS_SPEED changed
// from 0.95 → 0.85. Bump on any output-affecting change: voice
