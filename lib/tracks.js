...
// Ordered earliest-to-most-advanced. New tracks (Grade 3+) get appended.
export const TRACK_ORDER = ["e", "k", "a", "b"];
...
// lib/books.js and api/quiz.js carry a `grade` field like "PK", "K", "1", "2".
...
function defaultVisibleSet(workingGrade) {
  ...
  // G2 and above: everything K-2 we currently ship.
