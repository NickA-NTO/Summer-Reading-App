...
// currentlyReading lives ~365 days. 24h lets a kid read + quiz, take a
// break, and retell later the same day, while still self-cleaning stale
// state by the next day.
const READING_SESSION_TTL_SEC = 24 * 60 * 60;
