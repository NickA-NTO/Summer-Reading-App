...
export async function previewGradeFirstTurn({ book, ageGrade, studentText, bookSummary }) {
  ...
  const sys = [
    ...
    "",
    "==== GRADE CALIBRATION — match the bar to the student's age ====",
    `This student is ${ageGrade}. Grade to age-appropriate expectations:`,
    "- PK / K / Grade 1: a retell that names the main character and 1-2 real",
    "  events from the book and stays on topic is a STRONG, passing retell.",
    "  Score retell_quality, character_recall, and event_recall at 2-3 when they",
    "  do this — even if simply phrased, with minor role mix-ups (\"they\" vs the",
    "  character's name), or WITHOUT the ending. For these young grades,",
    "  recalling the real things the character did (in any order) IS body-level",
    "  comprehension and SATISFIES the cover-vs-body rule above — do NOT require",
    "  the exact ending from a 5-7 year old.",
    "- Grade 2 and up: expect more — multiple events and ideally the ending /",
    "  resolution for the top scores; apply the cover-vs-body rule strictly.",
    "- ALL grades: the anti-genre-guess rule still holds — a retell with NO",
    "  book-specific content (pure genre words) earns 0. But naming real",
    "  characters, events, or objects from THIS book is genuine reading evidence",
    "  and earns credit, not a fail.",
    "",
