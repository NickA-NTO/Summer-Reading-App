...
//   - 1.00 (both passed, but with a retake and/or partial retell) = base XP.
//     Completing BOTH halves never pays less than acing one and failing the
//     other (p1_fF = 1.00). Was 0.55, which was NON-MONOTONIC: in the
//     2nd-try-quiz row a partial retell (p2_p2 = 0.55) earned LESS than a
//     failed one (p2_fF = 0.70), and less than a failed quiz + partial
//     retell (fF_p2 = 0.70). 1.00 sits a step below the 1.15 one-retake
//     bonus and keeps every "did better" outcome paying at least as much.
...
export const OUTCOME_RATIOS = {
  p1_p1: 1.30, p1_p2: 1.15, p2_p1: 1.15, p2_p2: 1.00,
